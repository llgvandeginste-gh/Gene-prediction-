...
def plot_single_file(file_path):
    ...
    plt.suptitle("Analysis: Average TC Effect on Gene Prediction", fontsize=16, y=1.02)
    plt.tight_layout()
    plt.show()

# --- Execution ---
# Replace with your actual file name
plot_single_file(r'C:\Users\ilseh\Downloads\grid_with_TC_metrics_1.csv')