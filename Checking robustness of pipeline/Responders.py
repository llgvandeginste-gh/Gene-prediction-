...
data_path = os.path.join(base_path, 'Responders') # The subfolder
clusters = [1, 2, 3]
methods = ['0', 'a', 'b', 'c', 'd']
runs = range(1, 11)
...
for c in clusters:
    ...
    for m in methods:
        ...
        for r in runs:
            ...
            pred_file = f"response_names_{c}_{m}_{r}.txt"
        ...
        # 3. Save
        output_name = f"reliability_cluster_{c}_method_{m}_resp.csv"
